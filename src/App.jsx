...
// Todo1 Declare ตัว Component เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <header>
function Header() {
  return (
    <header>
      <nav>
...
// Todo2 Declare ตัว Component เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <main>
...
// Todo3 Declare ตัว Component เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <section className="product-section">
...
// Todo4 Declare ตัว Component เพื่อแบ่งสัดส่วนของ HTML Element ในส่วนของ <footer>
function Footer() {
  return (
    <footer>
...
// Todo5 Declare ตัว Component Button
// Todo6 เปลี่ยน Style ของปุ่ม “Add to Card”
function Button() {
